...
CALL registrarUsuarioAdmin('ma@acrolix.tech', '$2a$10$IU5YdFMQho72jT2yGpwpnOXvDmLInsCKHbyZ7MwdGk3QosB7JRnlW', 'Martín', 'Acosta', 'admin', TRUE, now());
CALL registrarUsuarioAdmin('mr@acrolix.tech', '$2a$10$IU5YdFMQho72jT2yGpwpnOXvDmLInsCKHbyZ7MwdGk3QosB7JRnlW', 'Matias', 'Rancel', 'admin', TRUE, NOW());
CALL registrarUsuarioAdmin('ml@acrolix.tech', '$2a$10$IU5YdFMQho72jT2yGpwpnOXvDmLInsCKHbyZ7MwdGk3QosB7JRnlW', 'Martín', 'Lorenzo', 'admin', TRUE, NOW());
CALL registrarUsuarioAdmin('ls@acrolix.tech', '$2a$10$IU5YdFMQho72jT2yGpwpnOXvDmLInsCKHbyZ7MwdGk3QosB7JRnlW', 'Lucas', 'Sancristobal', 'admin', TRUE, NOW());
CALL registrarUsuarioAdmin('test.admin@cromalink.acrolix.tech', '$2a$10$IU5YdFMQho72jT2yGpwpnOXvDmLInsCKHbyZ7MwdGk3QosB7JRnlW', 'Admin', 'Cromalink', 'admin', TRUE, NOW());
CALL registrarUsuarioAdmin('test.mod@cromalink.acrolix.tech', '$2a$10$IU5YdFMQho72jT2yGpwpnOXvDmLInsCKHbyZ7MwdGk3QosB7JRnlW', 'Moderador', 'Cromalink', 'moderador', TRUE, NOW());
